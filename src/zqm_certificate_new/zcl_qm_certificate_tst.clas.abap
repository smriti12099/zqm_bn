CLASS zcl_qm_certificate_tst DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC.
  ...
  PRIVATE SECTION.
    ...
    CONSTANTS lc_template_name TYPE string VALUE 'zqm_certificate/zqm_certificate'.
ENDCLASS.



CLASS ZCL_QM_CERTIFICATE_TST IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    ...
    SELECT SINGLE FROM i_inspectionlot AS a
      ...
      WHERE a~inspectionlot = '10000000123'
      INTO @DATA(wa_head).
